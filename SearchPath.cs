...
namespace AppParcial1Scripting
{
    ...
    class SearchPath
    {
        ...
        private Dictionary<(int,int), Node> _block = new Dictionary<(int, int), Node>();                           // For storing all the nodes with Node.cs
        
        private (int, int)[] _directions = { (0,-1), (-1, 0), (1, 0), (0, 1) };    // Directions to search in BFS
        ...
        public List<Node> Path
        {
            get
            {
                ...
                timeElapsed = sw.Elapsed; // guardar tiempo
                return _path; 
            }
        }
